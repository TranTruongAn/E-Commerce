...
namespace TMDT.Mail
{
    ...
    {
        public void SendMail(string toEmailAddress, string subject, string strMessage, Order order)
        {
            ...
            string FilePath = "E:\\Năm 4 - 1\\Thương mại điện tử\\Project\\TMDT\\Mail\\Email.html";
